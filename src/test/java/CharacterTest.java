...
public class CharacterTest {
    ...
    @Test
    @Order(1)
    @DisplayName("Clase Character: Constructor de Character y propiedades iniciales")
    ...
    @Test
    @Order(2)
    @DisplayName("Clase Character: Implementación de isAlive()")
    ...
    @Test
    @Order(3)
    @DisplayName("Clase Character: Implementación de getCurrentHealth()")
    ...
    @Test
    @Order(4)
    @DisplayName("Clase Character: Implementación de getName()")
    ...
    @Test
    @Order(5)
    @DisplayName("Clase Character: Implementación de getStatus()")
    ...
    @Test
    @Order(6)
    @DisplayName("Clase Character: Implementación de receiveDamage() - Reducción de salud y mínimo 0")
    ...
    @Test
    @Order(7)
    @DisplayName("Clase Character: Implementación de receiveDamage() - Cambio de estado a DEAD")
